...
export default class edit extends Component {
    ...
    componentDidMount() {
        ...
        ContactService.searchUserbyId(kid).then(res => {
            setTimeout(() => {
                this.setState({ users: res.data, id: kid, code: res.data.code });
                if (this.state.users.emergency === "emergency")
                    document.getElementById("emergency").checked = true;
                document.getElementById("name").value = this.state.users.name;
                document.getElementById("code").value = this.state.users.code;
                document.getElementById("email").value = this.state.users.email;
                document.getElementById("address").value = this.state.users.address;
                document.getElementById("country").value = this.state.users.code;
                document.getElementById("contact").value = this.state.users.contact;
            }, 1);
        });
    }
    ...
    handleClick = () => {
        const formfields = this.state.formFields;
        formfields["name"] = document.getElementById("name").value;
        formfields["code"] = document.getElementById("code").value;
        formfields["email"] = document.getElementById("email").value;
        formfields["address"] = document.getElementById("address").value;
        formfields["country"] = document.getElementById("country").value;
        formfields["contact"] = document.getElementById("contact").value;
        this.setState({
            formFields: formfields
        });
        ...
        if (this.state.errorcount === true) {
            ContactService.editContact(this.state.id, this.state.formFields).then((res) => {
        ...
        return (
            <div className="container">
                ...
                <div className="jumbotron my-0">
                    <div className="container">
                        <div className="row">
                            <div className="display-4 col-12 text-center">Welcome to <span className=" text-warning display-3" onClick={() => this.handleHomeClick()}>
                                <i class="fa fa-user" aria-hidden="true"></i> CBooK &nbsp; &nbsp;</span></div>
                            <div className="border-top border-warning col-12" />
                            <div className="h2 col-12 text-center">Edit YOur data</div>
                            <br />
                            <div className="col-12 col-md-3 col-sm-3 col-xl-3 col-lg-3 display-2 text-dark">
                            </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td className="text-left h4 text-dark ml-5 pl-5">
                                                <label>
                                                    Full Name:
                                                   <div className="text-danger text-left h6">
                                            ...
                                            <td>
                                                <div className="form-group">
                                                    <input type="text" id="name" ref='name' size="31" name="name" className=" border border-warning rounded" placeholder="Enter Full name" onChange={this.handleChange} />
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div className="form-group">
                                                    <input type="email" id="email" ref="email" size="31" name="email" className=" border border-warning rounded" placeholder="Enter Email Id" onChange={this.handleChange} />
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td className="text-left h4 text-dark ml-5 pl-5">
                                                <label>
                                                    Contact No.:
                                                    <div className="text-danger text-left h6">
                                                        {this.state.errors['contact']}{this.state.errors['code']}
                                                    </div>
                                                </label>
                                            </td>
                                            <td>
                                                <div className="form-group">
                                                    <input type="text" size="6" placeholder="Code" ref="country" id="country" name="code" value={this.state.code} className="border border-warning rounded" required onChange={this.handleChange} />
                                                    <input type="number" className=" border border-warning rounded" ref="contact" id="contact" name="contact" placeholder="Enter Phone" required onChange={this.handleChange} />
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <label class="form-check-label text-right h5 text-danger" for="gridCheck">
                                            ...
                                            <td>
                                                <div class="custom-control custom-checkbox text-left">
                                                    <input type="checkbox" class="btn-warning custom-control-input " name="emergency" ref="emergency" id="emergency" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="form-group">
                                                    <input type="submit" className="btn btn-warning form-control" id="submit" name="submit" value="Save Changes" required onClick={this.handleClick} />
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
